...
class Settings:
    ...
    state_schema_path: str = os.getenv("STATE_SCHEMA_PATH", "/app/state-schema.json")
    ...
    auth_session_cookie_name: str = os.getenv("GATEWAY_SESSION_COOKIE_NAME", "awareness_gateway_session")
    ...
    showroom_visitor_cookie_name: str = os.getenv("SHOWROOM_VISITOR_COOKIE_NAME", "awareness_showroom_visitor")
